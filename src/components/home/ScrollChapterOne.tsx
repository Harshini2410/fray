...
export default function ScrollChapterOne() {
  ...
  return (
    <section
      ...
      aria-label="We build, we create narrative"
    >
      <div className="sticky top-0 h-screen overflow-hidden">
        ...
        <div className="relative z-10 flex h-full items-center justify-center px-6">
          <div className="max-w-4xl text-center">
            ...
            >
              Chapter one moves from standards to platforms to systems—setting the
              foundation for dependable, enterprise-ready technology.
            </motion.p>
          </div>
        </div>
      </div>
