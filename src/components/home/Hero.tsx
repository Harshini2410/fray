...
export default function Hero() {
  ...
  // Handle mouse movement on section for cursor spotlight
  useEffect(() => {
    const handleMouseMove = (e: MouseEvent) => {
      ...
      // Update cursor spotlight position (relative to section)
  ...
  // Button magnetic effect (existing)
  ...
  return (
    ...
    >
      {/* Deep layered radial glow that subtly lifts on scroll */}
      <motion.div
        aria-hidden="true"
      ...
      {/* Star field with twinkle animation and parallax */}
      ...
      <motion.div
        ...
        style={{
          x: useTransform(springCursorX, (v) => v - 300),
          y: useTransform(springCursorY, (v) => v - 300),
          background:
      ...
      <Container className="relative z-10 flex w-full flex-col gap-12 py-20 sm:py-24 md:flex-row md:items-center md:justify-between lg:py-28 xl:py-32">
        ...
        >
          ...
          <motion.p
            ...
            custom={3}
          >
            Fraylon helps leadership teams architect and deliver digital
            platforms that feel considered, governed, and dependable—without
            losing the pace and clarity of modern product organisations.
          </motion.p>
          ...
          <motion.div
            ...
            custom={4}
          >
            {/* Primary CTA - magnetic + soft glow */}
            <motion.button
              type="button"
              onPointerMove={handlePointerMove}
              onPointerLeave={handlePointerLeave}
              className="relative inline-flex items-center justify-center overflow-hidden rounded-full bg-cyan-400 px-6 py-2.5 text-sm font-medium text-slate-950 shadow-[0_18px_45px_rgba(8,47,73,0.6)] transition-transform transition-colors duration-200 hover:bg-cyan-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-300/80 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-950 sm:px-7 sm:py-3 sm:text-base"
              style={{
